  ...
  const projects = [
    {
      ...
      description: "Designed and developed a web-based Data Validation System with two main features: validating SLA records that exceed standards by routing them to responsible teams for remarks, and enabling high-volume raw data uploads into separate staging databases to maintain data integrity and traceability using Laravel, React, and PostgreSQL. Optimized the data ingestion process to handle hundreds of thousands of records in under one minute, ensuring efficient and scalable data processing.",
      ...
      images: ["/assets/sisi/csa1.png", "/assets/sisi/csa2.png", "/assets/sisi/csa3.png", "/assets/sisi/csa4.png", "/assets/sisi/csa5.png", "/assets/sisi/csa6.png", "/assets/sisi/csa7.png", "/assets/sisi/csa8.png",  "/assets/sisi/csa9.png", "/assets/sisi/csa10.png", "/assets/sisi/csa11.png", "/assets/sisi/csa12.png"],
    },
    {
