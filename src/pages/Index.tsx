  ...
  const projects = [
    {
      ...
      description: "Designed and developed a web-based Data Validation System with two main module: validating SLA records that exceed standards by routing them to responsible teams for remarks, and enabling high-volume raw data uploads into separate staging databases to maintain data integrity and traceability using Laravel, React, and PostgreSQL. Optimized the data ingestion process to handle hundreds of thousands of records in under one minute, ensuring efficient and scalable data processing.",
