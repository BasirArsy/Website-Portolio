  ...
  const projects = [
    {
      ...
      description:
        "Designed and developing a web-based Data Validation System with two main features: validating SLA records that exceed standards by routing them to responsible teams for remarks, and enabling raw data uploads into separate raw_data and ready_data databases to maintain data integrity and traceability.",
